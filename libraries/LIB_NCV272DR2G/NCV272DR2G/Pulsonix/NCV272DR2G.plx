...
//14701913/1904684/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "NCV272DR2G" (originalName "NCV272DR2G")
	...
	(compDef "NCV272DR2G" (originalName "NCV272DR2G") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NCV272DR2G"))
		...
		(attr "Manufacturer_Part_Number" "NCV272DR2G")
		(attr "Description" "Wide Bandwidth: 3 MHz; Wide Power Supply Range: 2.7 to 36V; Low Supply Current: 416 A; Rail to Rail Output")
		(attr "<Hyperlink>" "https://www.onsemi.com/pub/Collateral/TLV271-D.PDF")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "NCV272DR2G.stp")
