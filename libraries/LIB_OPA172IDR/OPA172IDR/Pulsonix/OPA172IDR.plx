...
//755739/1904684/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "OPA172IDR" (originalName "OPA172IDR")
	...
	(compDef "OPA172IDR" (originalName "OPA172IDR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "OPA172IDR"))
		...
		(attr "Manufacturer_Part_Number" "OPA172IDR")
		(attr "Description" "36-V, Single-Supply, 10-MHz, Rail-to-Rail Output, Operational Amplifier")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/opa172")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "OPA172IDR.stp")
